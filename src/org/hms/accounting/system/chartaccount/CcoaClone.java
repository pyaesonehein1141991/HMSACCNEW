...
@Entity
@Table(name = TableName.CCOA_CLONE)
@TableGenerator(name = "CCOA_CLONE_GEN", table = "ID_GEN", pkColumnName = "GEN_NAME", valueColumnName = "GEN_VAL", pkColumnValue = "CCOA_CLONE_GEN", allocationSize = 10)
@EntityListeners(IDInterceptor.class)
public class CcoaClone implements Serializable {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.TABLE, generator = "CCOA_CLONE_GEN")
	private String id;
	...
	public CcoaClone(CurrencyChartOfAccount ccoa) {
		super();
		this.id = ccoa.getId();
